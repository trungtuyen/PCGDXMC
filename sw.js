const CACHE='pcgdxmc-v0.9.0';
const CORE=['./','./index.html','./styles.css','./core-v02.js','./reports-v02.js','./groups-v03.js','./viewer-v04.js','./app.js','./xmc-lists-v09.js','./manifest.webmanifest'];
